package com.yuque.sdk.exception;
...
public class YuqueException extends Exception {
    ...
    private YuqueException(Builder builder) {
    ...
    public static final class Builder {
        ...
        public Builder setHttpStatusLine(String httpStatusLine) {
            this.httpStatusLine = httpStatusLine;
            return this;
        }

        public Builder setOrigContent(String origContent) {
            this.origContent = origContent;
            return this;
        }

        public Builder setCustomErrorMsg(String customErrorMsg) {
            this.customErrorMsg = customErrorMsg;
            return this;
        }

        public Builder setOrigMsg(String origMsg){
            this.origMsg = origMsg;
            return this;
        }

        public Builder setOrigCode(String origCode){
            this.origCode = origCode;
            return this;
        }

        public Builder setOrigStatus(Integer origStatus){
            this.origStatus = origStatus;
            return this;
        }
